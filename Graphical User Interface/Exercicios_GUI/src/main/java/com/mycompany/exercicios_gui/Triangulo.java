...
public class Triangulo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Lado2 :");

        jLabel2.setText("Lado1 :");

        jLabel3.setText("Lado3 :");

        caixa2.addActionListener(this::caixa2ActionPerformed);

        caixa1.addActionListener(this::caixa1ActionPerformed);

        caixa3.addActionListener(this::caixa3ActionPerformed);
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(caixa3, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(caixa3, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(30, 30, 30)
                .addComponent(jButton1)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       numero1= Double.parseDouble(caixa1.getText());
       numero2= Double.parseDouble(caixa2.getText());
       numero3= Double.parseDouble(caixa3.getText());

      if(numero1 ==numero2 && numero2 ==numero3) {
      resultado.setVisible(true);
      resultado.setText("O triangulo é equilatero");
      }
      
     if(numero1 ==numero2) {
      resultado.setVisible(true);
      resultado.setText("O é isósceles");
      }
 ...
 if(numero2 ==numero3) {
  ...
  resultado.setVisible(true);
      resultado.setText("O Triangulo é escaleno");
 }
